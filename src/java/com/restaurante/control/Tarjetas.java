        ...
        if (op == null || !op.equals("6")) {
            ...
            if (accion == null) {
                ...
                try {
                    ...
                    tab.setPaginaEliminable("/Tarjetas?accion=eliminar" + "&op=" + op);
                    //pagina encargada de actualizacion
                    tab.setPaginaModificable("/Tarjetas?accion=modificar" + "&op=" + op);
                    //pagina encargada de seleccion para operaciones
                    tab.setPaginaSeleccionable("/Tarjetas?accion=modificar" + "&op=" + op);
                    ...
                    com.restaurante.utilerias.Permiso.getPermiso(s, "tarjetas/tarjetas_consulta.jsp", request, response, op);
                } catch (Exception ex) {
                    try {
                ...
                //Controlar los permisos
                request.setAttribute("opcion", op);
                com.restaurante.utilerias.Permiso.getPermiso(s, "tarjetas/insertar_modificar.jsp", request, response, op);
                ...
                response.sendRedirect(request.getContextPath() + "/Tarjetas" + "?op=" + op);
            }
        }
    }
