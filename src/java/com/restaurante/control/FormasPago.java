        ...
        if (op == null || !op.equals("17")) {
            ...
            if (accion == null) {
                ...
                try {
                    ...
                    tab.setPaginaEliminable("/FormasPago?accion=eliminar" + "&op=" + op);
                    //pagina encargada de actualizacion
                    tab.setPaginaModificable("/FormasPago?accion=modificar" + "&op=" + op);
                    //pagina encargada de seleccion para operaciones
                    tab.setPaginaSeleccionable("/FormasPago?accion=modificar" + "&op=" + op);
                    ...
                    com.restaurante.utilerias.Permiso.getPermiso(s, "formas_pago/formas_consulta.jsp", request, response, op);
                } catch (Exception ex) {
                    try {
                ...
                //Controlar los permisos
                request.setAttribute("opcion", op);
                com.restaurante.utilerias.Permiso.getPermiso(s, "formas_pago/insertar_modificar.jsp", request, response, op);
                ...
                response.sendRedirect(request.getContextPath() + "/FormasPago" + "?op=" + op);
            }
        }
    }
