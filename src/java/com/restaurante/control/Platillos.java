    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws
        ...
        if (accion == null) {
            ...
            try {
                ...
                tab.setPaginaEliminable("/Platillos?accion=eliminar");
                //pagina encargada de actualizacion
                tab.setPaginaModificable("/Platillos?accion=modificar");
                //pagina encargada de seleccion para operaciones
                tab.setPaginaSeleccionable("/Platillos?accion=modificar");
                ...
                request.getRequestDispatcher("platillos/platillos_consulta.jsp").forward(request, response);
            } catch (Exception ex) {
                try {
            ...
            request.getRequestDispatcher("platillos/insertar_modificar.jsp").forward(request, response);
            ...
            response.sendRedirect(request.getContextPath() + "/Platillos");
        }
    }
