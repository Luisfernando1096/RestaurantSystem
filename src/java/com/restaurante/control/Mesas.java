    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws
        ...
        if (accion == null) {
            ...
            try {
                ...
                tab.setPaginaEliminable("/Mesas?accion=eliminar");
                //pagina encargada de actualizacion
                tab.setPaginaModificable("/Mesas?accion=modificar");
                //pagina encargada de seleccion para operaciones
                tab.setPaginaSeleccionable("/Mesas?accion=modificar");
                ...
                request.getRequestDispatcher("mesas/mesas_consulta.jsp").forward(request, response);
            } catch (Exception ex) {
                try {
            ...
            request.getRequestDispatcher("mesas/insertar_modificar.jsp").forward(request, response);
