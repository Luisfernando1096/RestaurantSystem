    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (accion == null) {
            ...
            try {
                ...
                request.getRequestDispatcher("ordenes/ordenes_consulta.jsp").forward(request, response);
            } catch (Exception ex) {
...
// tab.setIconoEliminable("/iconos/delete.png");
                ...
                request.setAttribute("tabla", tabla01);
                request.getRequestDispatcher("ordenes/usuarios_cliente.jsp").forward(request,
                        response);
            } catch (Exception ex) {
                try {
                    Operaciones.rollback();
            ...
            try {
                ...
                request.setAttribute("tabla", tabla01);
                request.getRequestDispatcher("ordenes/listado_empleados.jsp").forward(request,
                        response);
            } catch (Exception ex) {
                try {
                    Operaciones.rollback();
            ...
            try {
                ...
                request.setAttribute("tabla", tabla01);
                request.getRequestDispatcher("ordenes/listado_tipo.jsp").forward(request, response);
            } catch (Exception ex) {
                try {
                    Operaciones.rollback();
                } catch (SQLException ex1) {
