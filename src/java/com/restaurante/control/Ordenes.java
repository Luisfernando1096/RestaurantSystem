        ...
        if (op == null || !op.equals("9")) {
            ...
            if (accion == null) {
                ...
                try {
                    ...
                    tab.setPaginaEliminable("/Ordenes?accion=eliminar");
                    ...
                    com.restaurante.utilerias.Permiso.getPermiso(s, "ordenes/ordenes_consulta.jsp", request, response, op);
                } catch (Exception ex) {
...
// tab.setIconoEliminable("/iconos/delete.png");
                    ...
                    //Controlar los permisos
                    request.setAttribute("opcion", op);
                    com.restaurante.utilerias.Permiso.getPermiso(s, "ordenes/usuarios_cliente.jsp", request, response, op);
                } catch (Exception ex) {
                    try {
                        Operaciones.rollback();
                    } catch (SQLException ex1) {
                ...
                try {
                    ...
                    //Controlar los permisos
                    request.setAttribute("opcion", op);
                    com.restaurante.utilerias.Permiso.getPermiso(s, "ordenes/listado_empleados.jsp", request, response, op);
                } catch (Exception ex) {
                    try {
                        Operaciones.rollback();
                    } catch (SQLException ex1) {
                ...
                try {
                    ...
                    //Controlar los permisos
                    request.setAttribute("opcion", op);
                    com.restaurante.utilerias.Permiso.getPermiso(s, "ordenes/listado_tipo.jsp", request, response, op);
                } catch (Exception ex) {
                    try {
                        Operaciones.rollback();
                    } catch (SQLException ex1) {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            response.sendRedirect(request.getContextPath() + "/Ordenes?idCliente=" + idCliente + "&cliente=" + cliente);
        } catch (Exception ex) {
            try {
                Operaciones.rollback();
