        ...
        if (op == null || !op.equals("16")) {
            ...
            if (accion == null) {
                ...
                try {
                    ...
                    tab.setPaginaEliminable("/BebidaOrden?accion=eliminar" + "&op=" + op);
                    //pagina encargada de actualizacion
                    tab.setPaginaModificable("/BebidaOrden?accion=modificar" + "&op=" + op);
                    //pagina encargada de seleccion para operaciones
                    tab.setPaginaSeleccionable("/BebidaOrden?accion=modificar" + "&op=" + op);
                    ...
                    com.restaurante.utilerias.Permiso.getPermiso(s, "bebidas_orden/bebidas_orden_consulta.jsp", request, response, op);
                } catch (Exception ex) {
                    try {
                ...
                //Controlar los permisos
                request.setAttribute("opcion", op);
                com.restaurante.utilerias.Permiso.getPermiso(s, "bebidas_orden/insertar_modificar.jsp", request, response, op);
                ...
                response.sendRedirect(request.getContextPath() + "/BebidaOrden" + "?op=" + op);
            }
        }
    }
