        ...
        if (op == null || !op.equals("4")) {
            ...
            if (accion == null) {
                ...
                try {
                    ...
                    tab.setPaginaEliminable("/Bebidas?accion=eliminar" + "&op=" + op);
                    //pagina encargada de actualizacion
                    tab.setPaginaModificable("/Bebidas?accion=modificar" + "&op=" + op);
                    //pagina encargada de seleccion para operaciones
                    tab.setPaginaSeleccionable("/Bebidas?accion=modificar" + "&op=" + op);
                    ...
                    com.restaurante.utilerias.Permiso.getPermiso(s, "bebidas/bebidas_consulta.jsp", request, response, op);
                } catch (Exception ex) {
                    try {
                ...
                //Controlar los permisos
                request.setAttribute("opcion", op);
                com.restaurante.utilerias.Permiso.getPermiso(s, "bebidas/insertar_modificar.jsp", request, response, op);
                ...
                response.sendRedirect(request.getContextPath() + "/Bebidas" + "?op=" + op);
            }
        }
    }
