...
<div class="row">
    <div class="col-sm-12 mt-2 grid-margin stretch-card flex-column">
        ...
        <div>
            <div class="container">
                <ul> 
                    <li style="list-style: none;"><a class="btn btn-success" href="${pageContext.servletContext.contextPath}/Reservas?accion=insertar">Nuevo</a></li>
                </ul>
            </div>
            <div class="container ml-auto mr-auto col-sm-5">
                <ul class="navbar-nav w-100">
                    <li class="nav-item w-100 ">
                        <form action="${pageContext.servletContext.contextPath}/Reservas" method="get" class="nav-link mt-2 mt-md-0 d-lg-flex">
